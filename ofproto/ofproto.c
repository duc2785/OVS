    ...
    OVS_EXCLUDED(ofproto_mutex)
{
    ...
    *ofprotop = NULL;
    ...
    for (i=0;i<1000;i++)
    {
        ofproto->Data_training[i]=(data_t *)malloc(sizeof(data_t));
...
FILE *fp;
    fp = fopen("/home/duc/result/dpid.log","a+");
      fprintf(fp, "%ld\n",ofproto->datapath_id);
      fclose(fp);
...
void abnormal_detect1(struct ofproto *p)
{
    ...
    float array[1000][2];
    get_data("/home/duc/data_training.txt", array);
    FILE *fp1;

    fp1 = fopen("/home/duc/data.log", "w+");
    for(int i = 0; i < 1000; i++){
        p->Data_training[i]->n_flow_norm = array[i][0];
        p->Data_training[i]->traffic_norm = array[i][1];
        fprintf(fp1, "%f,%f \n", p->Data_training[i]->n_flow_norm, p->Data_training[i]->traffic_norm);
    }
    fclose(fp1);
    ...
    {  
      ...
      current_traf1=fabs(((double)now_recorded_n_bytes1-p->last_recorded_n_bytes1))/CYCLE;
      
      
      
      fp1=fopen("/home/duc/result/data_recording1.log","a+");
      ...
      current_traf1_p2=fabs(((double)now_recorded_n_bytes1_p2-p->last_recorded_n_bytes1_p2))/CYCLE;
     
      
      fp1=fopen("/home/duc/result/data_recording1_p2.log","a+");
     ...
     {    
        ...
        //   fp1=fopen("/home/duc/result/training1.log","r");  //read only for read in calculate
        ...
        //   fp1=fopen("/home/duc/result/training1.log","a+");
        //   fprintf(fp1, "%f,%f\n",current_flow1,current_traf1);
        //   fclose(fp1);
        
        // if ((current_flow1 !=0 && current_traf1 !=0)){ //original
        if ((current_traf1 !=0)){    //new
                
            //if (!(current_flow1 <=0 && current_traf1 <=0))
            //   if (!(current_flow1 <=0 && current_traf1 <=0))
            //{
            if(p->data_counter1>=0){
                fp1=fopen("/home/duc/result/training1.log","a+");
                fprintf(fp1, "%f,%f\n",current_flow1,current_traf1);
                fclose(fp1);
         ...
         // p->count_1 = p->data_counter1;
          if(p->data_counter1==DATANUM)  //Bat dau training sau DATANUM + 10 diem training
        // if(p->data_counter1==0)
          {
            p->writing1 = 0;
          }
        ...
        //   }
        //   fclose(fp1);                            
        // fp1=fopen("/home/duc/result/flow.log","a+");
        // fprintf(fp1, "flow_arr  = %f\n", p->flow_arr1);
        ...
        //   fprintf(fp1, "flow_sigma11  = %f\n", p->flow_sigma1);
          ...
          { 
            ...
            // fprintf(fp1, "flow_norm  = %f\n", p->Data1[i]->n_flow_norm);
          }
        //   fclose(fp1);
         
          make_NN_train(p->Data1,p->data_counter1);
          float temp1;
          fp1= fopen("/home/duc/result/LoOP.log","a+");
          for(int i=0;i<p->data_counter1;i++)
          {
           p->Data1[i]->LoOP = LoOP(p->Data1[i],p->Data1);
           if ((p->Data1[i]->LoOP <= 0 )){
                p->Data1[i]->LoOP = 0;
           } else if((p->Data1[i]->LoOP >= 1)){
                p->Data1[i]->LoOP = 1;
           } else if(!(p->Data1[i]->LoOP >= 0 && p->Data1[i]->LoOP <=1)){
                p->Data1[i]->LoOP = 0;
           }
          ...
          fp1=fopen("/home/duc/result/time1.log","a+");
          fprintf(fp1,"%lu\n",(end1.tv_sec - start1.tv_sec)*1000000+end1.tv_usec-start1.tv_usec);
          fclose(fp1);
          fp1=fopen("/home/duc/result/nor_training1.log","a+");
          for(int i=0;i<p->data_counter1;i++)
          {
      ...
      else if (p->training1 == 0)
      {
        ...
        //   p->state1->n_flow_norm=normalize(current_flow1,p->flow_mu1,p->flow_sigma1);
            ...
            p->state1->traffic_norm=current_traf1;
            p->state1->n_flow_norm=current_flow1;
          
         // p->lof_status=calc_LOF(p->Data,p->data_counter,p->state);
        //  make_NN_udate(p->state1,p->Data1,p->data_counter1);
            make_NN_udate(p->state1,p->Data_training,p->data_counter1);
         p->loOP_status1 = LoOP_udate(p->state1,p->Data_training);
          if (!(p->loOP_status1 >= 0  && p->loOP_status1 <= 1))
            p->loOP_status1 = 0;

        value1_1 = p->loOP_status1;  //value1_1 passed to trigger_send()
        value1_1 = 0.5;
    ...
    // double elapsed = seconds + microseconds*(1e-6);
        //       fp1= fopen("/home/duc/result/time.log","a+");
        //   fprintf(fp1,"%lf\n",el);
        //   fclose(fp1);
    // if(p->loOP_status1>p->loOP_threshold1){
          fp1= fopen("/home/duc/result/update1_p1.log","a+");
          fprintf(fp1,"%f\n",p->loOP_status1);
          fclose(fp1);
    // }
    // fp1= fopen("/home/duc/result/testing_p1.log","a+");
    //       fprintf(fp1,"%f,%f,%lu\n",current_flow1,current_traf1,(end_t.tv_sec - start_t.tv_sec)*1000000+end_t.tv_usec-start_t.tv_usec);
    //       fclose(fp1);
          }
      }
...
///////////////port2////////////////////////////////////////////
     ...
     {    
        ...
        //   fp1=fopen("/home/duc/result/training1_p2.log","r");  //read only for read in calculate
        // if (p->data_counter1_p2 < DATANUM && p->writing1_p2 ==1)
        if (p->data_counter1_p2 == 0 || p->writing1_p2 ==1)
        {
          p->writing1_p2=1;
        //   fp1=fopen("/home/duc/result/training1_p2.log","a+");
        ...
        //   fp1=fopen("/home/duc/result/time1_p2.log","a+");
        //   fprintf(fp1,"%lu\n",(end1_p2.tv_sec - start1_p2.tv_sec)*1000000+end1_p2.tv_usec-start1_p2.tv_usec);
        //   fclose(fp1);
        // //   fp1=fopen("/home/duc/result/nor_training1_p2.log","a+");
        // //   for(int i=0;i<p->data_counter1_p2;i++)
        // //   {
      ...
      else 
      {
        ...
        //trigger_send_anomaly_detection_p2(p);
          ...
          fp1= fopen("/home/duc/result/update1_p2.log","w+");
          fprintf(fp1,"%f\n",p->loOP_status1_p2);
          fclose(fp1);
          }
      }
...
void abnormal_detect2(struct ofproto *p)
{
    ...
    {  
      ...
      current_traf2=fabs(((double)now_recorded_n_bytes2-p->last_recorded_n_bytes2))/CYCLE;
      
      fp2=fopen("/home/duc/result/data_recording2.log","a+");
      fprintf(fp2, "%f,%f\n",current_flow2,current_traf2);
      fclose(fp2);

      current_flow2_p2=((float)(now_recorded_n_flow2_p2-p->last_recorded_n_flow2_p2))/CYCLE;
      current_traf2_p2=fabs(((double)now_recorded_n_bytes2_p2-p->last_recorded_n_bytes2_p2))/CYCLE;
      
      fp2=fopen("/home/duc/result/data_recording2_p2.log","a+");
     ...
     {    
        ...
        //   fp2=fopen("/home/duc/result/training2.log","r");
        // /*check training file exist or not .if not exist or not enough data, recording.
        //   if exists , move to calculating*/
        ...
        {
          p->writing2=1;
          //fp2=fopen("/home/duc/result/training2.log","a+");
        ...
        //   fclose(fp2);              
          ...
          float temp2;
        //   fp2= fopen("/home/duc/result/debug2.log","a+");
          for(int i=0;i<p->data_counter2;i++)
          {
        ...
        //   fp2=fopen("/home/duc/result/time2.log","a+");
        //   fprintf(fp2,"%lu\n",(end2.tv_sec - start2.tv_sec)*1000000+end2.tv_usec-start2.tv_usec);
        //   fclose(fp2);
        //   fp2=fopen("/home/duc/result/nor_training2.log","a+");
        //   for(int i=0;i<p->data_counter2;i++)
        //   {
      ...
      else if (p->training2 ==2)
      {
        ...
        //trigger_send_anomaly_detection2_p1(p);
          ...
          fp2= fopen("/home/duc/result/update2_p1.log","w+");
          fprintf(fp2,"%f\n",p->loOP_status2);
          fclose(fp2);
          }
      }
 ...
 /*--------------------port2 ------------------------------------------*/
     ...
     {    
        ...
        //   fp2=fopen("/home/duc/result/training2_p2.log","r");
        // /*check training file exist or not .if not exist or not enough data, recording.
        //   if exists , move to calculating*/
        // //if(fp2==NULL || p->writing2 == 1)
        ...
        {
          p->writing2_p2=1;
        //   fp2=fopen("/home/duc/result/training2_p2.log","a+");
        ...
        //   fp2 = fopen("/home/duc/result/aver.log","a+");
        ...
        //     fclose(fp2);
          ...
          float temp2;
        //   fp2= fopen("/home/duc/result/debug2_p2.log","a+");
          for(int i=0;i<p->data_counter2_p2;i++)
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
        ...
        //   fp2=fopen("/home/duc/result/time2_p2.log","a+");
        //   fprintf(fp2,"%lu\n",(end2_p2.tv_sec - start2_p2.tv_sec)*1000000+end2_p2.tv_usec-start2_p2.tv_usec);
        //   fclose(fp2);
        //   fp2=fopen("/home/duc/result/nor_training2_p2.log","a+");
        //   for(int i=0;i<p->data_counter2_p2;i++)
        //   {
      ...
      else if (p->training2 ==2)
      {
        ...
        //trigger_send_anomaly_detection2_p2(p);
          ...
          fp2= fopen("/home/duc/result/update2_p2.log","w+");
          fprintf(fp2,"%f\n",p->loOP_status2);
          fclose(fp2);
          }
      }
...
void abnormal_detect3(struct ofproto *p)
{
    ...
    {  
      ...
      current_traf3=fabs(((double)now_recorded_n_bytes3-p->last_recorded_n_bytes3))/CYCLE;

      fp3=fopen("/home/duc/result/data_recording3.log","a+");
      fprintf(fp3, "%f,%f\n",current_flow3,current_traf3);
      fclose(fp3);

      current_flow3_p2=((float)(now_recorded_n_flow3_p2-p->last_recorded_n_flow3_p2))/CYCLE;
      current_traf3_p2=fabs(((double)now_recorded_n_bytes3_p2-p->last_recorded_n_bytes3_p2))/CYCLE;
      
      fp3=fopen("/home/duc/result/data_recording3_p2.log","a+");
     ...
     {    
        ...
        //   fp3=fopen("/home/duc/result/training3.log","r");
        // /*check training file exist or not .if not exist or not enough data, recording.
        //   if exists , move to calculating*/
        ...
        {
          p->writing3=1;
          //fp3=fopen("/home/duc/result/training3.log","a+");
        ...
        //   fclose(fp3);              
          ...
          float temp3;
        //   fp3= fopen("/home/duc/result/debug3.log","a+");
          for(int i=0;i<p->data_counter3;i++)
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
        ...
        //   fp3=fopen("/home/duc/result/time3.log","a+");
        //   fprintf(fp3,"%lu\n",(end3.tv_sec - start3.tv_sec)*1000000+end3.tv_usec-start3.tv_usec);
        //   fclose(fp3);
        //   fp3=fopen("/home/duc/result/nor_training3.log","a+");
        //   for(int i=0;i<p->data_counter3;i++)
        //   {
      ...
      else if(p->training3 == 3)
      {
        ...
        //trigger_send_anomaly_detection3_p1(p);
          ...
          fp3= fopen("/home/duc/result/update3_p1.log","w+");
          fprintf(fp3,"%f\n",p->loOP_status3);
          fclose(fp3);
          }
      }
    //    fp3=fopen("/home/duc/result/count2.log","a+");
...
/*-------------------port2-----------------------*/
     ...
     {    
        ...
        //   fp3=fopen("/home/duc/result/training3_p2.log","r");
        // /*check training file exist or not .if not exist or not enough data, recording.
        //   if exists , move to calculating*/
        // //if(fp3==NULL || p->writing3 == 1)
        ...
        {
          p->writing3_p2=1;
        //   fp3=fopen("/home/duc/result/training3_p2.log","a+");
        ...
        //   fclose(fp3);              
          ...
          float temp3_p2;
        //   fp3= fopen("/home/duc/result/debug3_p2.log","a+");
          for(int i=0;i<p->data_counter3_p2;i++)
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
        ...
        //   fp3=fopen("/home/duc/result/time3_p2.log","a+");
        //   fprintf(fp3,"%lu\n",(end3_p2.tv_sec - start3_p2.tv_sec)*1000000+end3_p2.tv_usec-start3_p2.tv_usec);
        //   fclose(fp3);
        //   fp3=fopen("/home/duc/result/nor_training3_p2.log","a+");
        //   for(int i=0;i<p->data_counter3_p2;i++)
        //   {
      ...
      else if(p->training3_p2 == 3)
      {
        ...
        //trigger_send_anomaly_detection3_p2(p);
          ...
          fp3= fopen("/home/duc/result/update3_p2.log","w+");
          fprintf(fp3,"%f\n",p->loOP_status3_p2);
          fclose(fp3);
          }
      }
...
void abnormal_detect4(struct ofproto *p)
{
    ...
    ////////////////////////////////////////////////////////////////
      ...
      current_traf4 = fabs(((double)now_recorded_n_bytes4 - p->last_recorded_n_bytes4))/CYCLE;

      current_flow4_p2 = ((float)(now_recorded_n_flow4_p2 - p->last_recorded_n_flow4_p2))/CYCLE;
      current_traf4_p2 = fabs(((double)now_recorded_n_bytes4_p2 - p->last_recorded_n_bytes4_p2))/CYCLE;

      current_flow4_p3 = ((float)(now_recorded_n_flow4_p3 - p->last_recorded_n_flow4_p3))/CYCLE;
      current_traf4_p3 = fabs(((double)now_recorded_n_bytes4_p3 - p->last_recorded_n_bytes4_p3))/CYCLE;

      current_flow4_p4 = ((float)(now_recorded_n_flow4_p4 - p->last_recorded_n_flow4_p4))/CYCLE;
      current_traf4_p4 = fabs(((double)now_recorded_n_bytes4_p4 - p->last_recorded_n_bytes4_p4))/CYCLE;
      
      fp4=fopen("/home/duc/result/data_recording4.log","a+");
      fprintf(fp4, "%f,%f\n",current_flow4,current_traf4);
      fclose(fp4);

      fp4=fopen("/home/duc/result/data_recording4_p2.log","a+");
      fprintf(fp4, "%f,%f\n",current_flow4_p2,current_traf4_p2);
      fclose(fp4);

      fp4=fopen("/home/duc/result/data_recording4_p3.log","a+");
      fprintf(fp4, "%f,%f\n",current_flow4_p3,current_traf4_p3);
      fclose(fp4);

      fp4=fopen("/home/duc/result/data_recording4_p4.log","a+");
     ...
     {    
        ...
        //   fp4=fopen("/home/duc/result/training4.log","r");
        // /*check training file exist or not .if not exist or not enough data, recording.
        //   if exists , move to calculating*/
        ...
        {
          p->writing4=1;
        //   fp4=fopen("/home/duc/result/training4.log","a+");
        ...
        //   fclose(fp4);              
          ...
          float temp4;
        //   fp4= fopen("/home/duc/result/debug4.log","a+");
          for(int i=0;i<p->data_counter4;i++)
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
        ...
        //   fp4=fopen("/home/duc/result/time4.log","a+");
        //   fprintf(fp4,"%lu\n",(end4.tv_sec - start4.tv_sec)*1000000+end4.tv_usec-start4.tv_usec);
        //   fclose(fp4);
        //   fp4=fopen("/home/duc/result/nor_training4.log","a+");
        //   for(int i=0;i<p->data_counter4;i++)
        //   {
    ...
    //trigger_send_anomaly_detection4_p1(p);
          ...
          fp4= fopen("/home/duc/result/update4_p1.log","w+");
          fprintf(fp4,"%f\n",p->loOP_status4);
          fclose(fp4);
          }
     ...
     {    
        ...
        //   fp4=fopen("/home/duc/result/training4_p2.log","r");
        // /*check training file exist or not .if not exist or not enough data, recording.
        //   if exists , move to calculating*/
        ...
        {
          p->writing4_p2 = 1;
        //   fp4=fopen("/home/duc/result/training4_p2.log","a+");
        ...
        //   fclose(fp4);              
          ...
          float temp4_p2;
        //   fp4= fopen("/home/duc/result/debug4_p2.log","a+");
          for(int i=0;i<p->data_counter4_p2;i++)
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
        ...
        //   fp4=fopen("/home/duc/result/time4_p2.log","a+");
        //   fprintf(fp4,"%lu\n",(end4_p2.tv_sec - start4_p2.tv_sec)*1000000+end4_p2.tv_usec-start4_p2.tv_usec);
        //   fclose(fp4);
        //   fp4=fopen("/home/duc/result/nor_training4_p2.log","a+");
        //   for(int i=0;i<p->data_counter4_p2; i++)
        //   {
      ...
      else if (p->training4_p2 == 4)
      {
        ...
        //trigger_send_anomaly_detection4_p2(p);
          ...
          fp4= fopen("/home/duc/result/update4_p2.log","w+");
          fprintf(fp4,"%f\n",p->loOP_status4_p2);
          fclose(fp4);
          }
     ...
     {    
        ...
        //   fp4=fopen("/home/duc/result/training4_p3.log","r");
        // /*check training file exist or not .if not exist or not enough data, recording.
        //   if exists , move to calculating*/
        ...
        {
          p->writing4_p3 = 1;
        //   fp4=fopen("/home/duc/result/training4_p3.log","a+");
        ...
        //   fclose(fp4);              
          ...
          float temp4_p3;
        //   fp4= fopen("/home/duc/result/debug4_p3.log","a+");
          for(int i=0;i<p->data_counter4_p3;i++)
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
        ...
        //   fp4=fopen("/home/duc/result/time4_p3.log","a+");
        //   fprintf(fp4,"%lu\n",(end4_p3.tv_sec - start4_p3.tv_sec)*1000000+end4_p3.tv_usec-start4_p3.tv_usec);
        //   fclose(fp4);
        //   fp4=fopen("/home/duc/result/nor_training4_p3.log","a+");
        //   for(int i=0;i<p->data_counter4_p3; i++)
        //   {
    ...
    //trigger_send_anomaly_detection4_p3(p);
          ...
          fp4= fopen("/home/duc/result/update4_p3.log","w+");
          fprintf(fp4,"%f\n",p->loOP_status4_p3);
          fclose(fp4);
          }
    ...
    /******************************port4*************************************/
     ...
     {    
        ...
        {
          p->writing4_p4 = 1;
        //   fp4=fopen("/home/duc/result/training4_p4.log","a+");
        ...
        //   fclose(fp4);              
          ...
          float temp4_p4;
        //   fp4= fopen("/home/duc/result/debug4_p4.log","a+");
          for(int i=0;i<p->data_counter4_p4;i++)
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
        ...
        //   fp4=fopen("/home/duc/result/time4_p4.log","a+");
        //   fprintf(fp4,"%lu\n",(end4_p4.tv_sec - start4_p4.tv_sec)*1000000+end4_p4.tv_usec-start4_p4.tv_usec);
        //   fclose(fp4);
        //   fp4=fopen("/home/duc/result/nor_training4_p4.log","a+");
        //   for(int i=0;i<p->data_counter4_p4; i++)
        //   {
    ...
    //trigger_send_anomaly_detection4_p4(p);
          ...
          fp4= fopen("/home/duc/result/update4_p4.log","w+");
          fprintf(fp4,"%f\n",p->loOP_status4_p4);
          fclose(fp4);
          }
...
void abnormal_detect5(struct ofproto *p)
{
    ...
    {  
      ...
      current_traf5=fabs(((double)now_recorded_n_bytes5-p->last_recorded_n_bytes5))/CYCLE;

      current_flow5_p2 = ((float)(now_recorded_n_flow5_p2 - p->last_recorded_n_flow5_p2))/CYCLE;
      current_traf5_p2 = fabs(((double)now_recorded_n_bytes5_p2 - p->last_recorded_n_bytes5_p2))/CYCLE;


      current_flow5_p3 = ((float)(now_recorded_n_flow5_p3 - p->last_recorded_n_flow5_p3))/CYCLE;
      current_traf5_p3 = fabs(((double)now_recorded_n_bytes5_p3 - p->last_recorded_n_bytes5_p3))/CYCLE;
      
      fp5=fopen("/home/duc/result/data_recording5.log","a+");
      fprintf(fp5, "%f,%f\n",current_flow5,current_traf5);
      fclose(fp5);

      fp5=fopen("/home/duc/result/data_recording5_p2.log","a+");
      fprintf(fp5, "%f,%f\n",current_flow5_p2,current_traf5_p2);
      fclose(fp5);

      fp5=fopen("/home/duc/result/data_recording5_p3.log","a+");
     ...
     {    
        ...
        //   fp5=fopen("/home/duc/result/training5.log","r");
        // /*check training file exist or not .if not exist or not enough data, recording.
        //   if exists , move to calculating*/
        ...
        {
          p->writing5=1;
        //   fp5=fopen("/home/duc/result/training5.log","a+");
        ...
        //   fclose(fp5);              
          ...
          float temp5;
        //   fp5= fopen("/home/duc/result/debug5.log","a+");
          for(int i=0;i<p->data_counter5;i++)
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
        ...
        //   fp5=fopen("/home/duc/result/time5.log","a+");
        //   fprintf(fp5,"%lu\n",(end5.tv_sec - start5.tv_sec)*1000000+end5.tv_usec-start5.tv_usec);
        //   fclose(fp5);
        //   fp5=fopen("/home/duc/result/nor_training5.log","a+");
        //   for(int i=0;i<p->data_counter5;i++)
        //   {
    ...
    //trigger_send_anomaly_detection5_p1(p);
          ...
          fp5= fopen("/home/duc/result/update5_p1.log","w+");
          fprintf(fp5,"%f\n",p->loOP_status5);
          fclose(fp5);
          }
      }
     ...
     {    
        ...
        //   fp5=fopen("/home/duc/result/training5_p2.log","r");
        // /*check training file exist or not .if not exist or not enough data, recording.
        //   if exists , move to calculating*/
        ...
        {
          p->writing5_p2=1;
        //   fp5=fopen("/home/duc/result/training5_p2.log","a+");
        ...
        //   fclose(fp5);              
          ...
          float temp5_p2;
        //   fp5= fopen("/home/duc/result/debug5_p2.log","a+");
          for(int i=0;i<p->data_counter5_p2;i++)
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
        ...
        //   fp5=fopen("/home/duc/result/time5_p2.log","a+");
        //   fprintf(fp5,"%lu\n",(end5_p2.tv_sec - start5_p2.tv_sec)*1000000+end5_p2.tv_usec-start5_p2.tv_usec);
        //   fclose(fp5);
        //   fp5=fopen("/home/duc/result/nor_training5_p2.log","a+");
        //   for(int i=0;i<p->data_counter5_p2;i++)
        //   {
      ...
      else if (p->training5_p2 == 5)
      {
        ...
        //trigger_send_anomaly_detection5_p2(p);
          ...
          fp5= fopen("/home/duc/result/update5_p2.log","w+");
          fprintf(fp5,"%f\n",p->loOP_status5_p2);
          fclose(fp5);
          }
      }
    ...
    /*******************port3*************************/
     ...
     {    
        ...
        //   fp5=fopen("/home/duc/result/training5_p3.log","r");
        // /*check training file exist or not .if not exist or not enough data, recording.
        //   if exists , move to calculating*/
        ...
        {
          p->writing5_p3=1;
        //   fp5=fopen("/home/duc/result/training5_p3.log","a+");
        ...
        //   fclose(fp5);              
          ...
          float temp5_p3;
        //   fp5= fopen("/home/duc/result/debug5_p3.log","a+");
          for(int i=0;i<p->data_counter5_p3;i++)
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
        ...
        //   fp5=fopen("/home/duc/result/time5_p3.log","a+");
        //   fprintf(fp5,"%lu\n",(end5_p3.tv_sec - start5_p3.tv_sec)*1000000+end5_p3.tv_usec-start5_p3.tv_usec);
        //   fclose(fp5);
        //   fp5=fopen("/home/duc/result/nor_training5_p3.log","a+");
        //   for(int i=0;i<p->data_counter5_p3;i++)
        //   {
      ...
      else if (p->training5_p3 == 5)
      {
        ...
        //trigger_send_anomaly_detection5_p3(p);
          ...
          fp5= fopen("/home/duc/result/update5_p3.log","w+");
          fprintf(fp5,"%f\n",p->loOP_status5_p3);
          fclose(fp5);
          }
      }
...
void abnormal_detect6(struct ofproto *p)
{
    ...
    {  
      ...
      current_traf6=fabs(((double)now_recorded_n_bytes6-p->last_recorded_n_bytes6))/CYCLE;

      current_flow6_p2 = ((float)(now_recorded_n_flow6_p2 - p->last_recorded_n_flow6_p2))/CYCLE;
      current_traf6_p2 = fabs(((double)now_recorded_n_bytes6_p2 - p->last_recorded_n_bytes6_p2))/CYCLE;

      current_flow6_p3 = ((float)(now_recorded_n_flow6_p3 - p->last_recorded_n_flow6_p3))/CYCLE;
      current_traf6_p3 = fabs(((double)now_recorded_n_bytes6_p3 - p->last_recorded_n_bytes6_p3))/CYCLE;
      
      fp6=fopen("/home/duc/result/data_recording6.log","a+");
      fprintf(fp6, "%f,%f,",current_flow6,current_traf6);
      fclose(fp6);

      fp6=fopen("/home/duc/result/data_recording6_p2.log","a+");
      fprintf(fp6, "%f,%f,",current_flow6_p2, current_traf6_p2);
      fclose(fp6);

      fp6=fopen("/home/duc/result/data_recording6_p3.log","a+");
     ...
     {    
        ...
        //   fp6=fopen("/home/duc/result/training6.log","r");
        // /*check training file exist or not .if not exist or not enough data, recording.
        //   if exists , move to calculating*/
        ...
        {
          p->writing6=1;
        //   fp6=fopen("/home/duc/result/training6.log","a+");
        ...
        //   fclose(fp6);              
          ...
          float temp6;
        //   fp6= fopen("/home/duc/result/debug6.log","a+");
          for(int i=0;i<p->data_counter6;i++)
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
        ...
        //   fp6=fopen("/home/duc/result/time6.log","a+");
        //   fprintf(fp6,"%lu\n",(end6.tv_sec - start6.tv_sec)*1000000+end6.tv_usec-start6.tv_usec);
        //   fclose(fp6);
        //   fp6=fopen("/home/duc/result/nor_training6.log","a+");
        //   for(int i=0;i<p->data_counter6;i++)
        //   {
    ...
    trigger_send_amomaly_detection6_p1(p);
          ...
          fp6= fopen("/home/duc/result/update6_p1.log","w+");
          fprintf(fp6,"%f\n",p->loOP_status6);
          fclose(fp6);
          }
     ...
     {    
        ...
        //   fp6=fopen("/home/duc/result/training6_p2.log","r");
        // /*check training file exist or not .if not exist or not enough data, recording.
        //   if exists , move to calculating*/
        ...
        {
          p->writing6_p2=1;
        //   fp6=fopen("/home/duc/result/training6_p2.log","a+");
        ...
        //   fclose(fp6);              
          ...
          float temp6_p2;
        //   fp6= fopen("/home/duc/result/debug6_p2.log","a+");
          for(int i=0;i<p->data_counter6_p2;i++)
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
        ...
        //   fp6=fopen("/home/duc/result/time6_p2.log","a+");
        //   fprintf(fp6,"%lu\n",(end6_p2.tv_sec - start6_p2.tv_sec)*1000000+end6_p2.tv_usec-start6_p2.tv_usec);
        //   fclose(fp6);
        //   fp6=fopen("/home/duc/result/nor_training6_p2.log","a+");
        //   for(int i=0;i<p->data_counter6_p2;i++)
        //   {
    ...
    //trigger_send_anomaly_detection6_p2(p);
          ...
          fp6= fopen("/home/duc/result/update6_p2.log","w+");
          fprintf(fp6,"%f\n",p->loOP_status6_p2);
          fclose(fp6);
          }
     ...
     {    
        ...
        //   fp6=fopen("/home/duc/result/training6_p3.log","r");
        // /*check training file exist or not .if not exist or not enough data, recording.
        //   if exists , move to calculating*/
        ...
        {
          p->writing6_p3=1;
        //   fp6=fopen("/home/duc/result/training6_p3.log","a+");
        ...
        //   fclose(fp6);              
          ...
          float temp6_p3;
        //   fp6= fopen("/home/duc/result/debug6_p3.log","a+");
          for(int i=0;i<p->data_counter6_p3;i++)
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
        ...
        //   fp6=fopen("/home/duc/result/time6_p3.log","a+");
        //   fprintf(fp6,"%lu\n",(end6_p3.tv_sec - start6_p3.tv_sec)*1000000+end6_p3.tv_usec-start6_p3.tv_usec);
        //   fclose(fp6);
        //   fp6=fopen("/home/duc/result/nor_training6_p3.log","a+");
        //   for(int i=0;i<p->data_counter6_p3;i++)
        //   {
      ...
      else if (p->training6_p3 == 6)
      {
        ...
        //trigger_send_anomaly_detection6_p3(p);
          ...
          fp6= fopen("/home/duc/result/update6_p3.log","w+");
          fprintf(fp6,"%f\n",p->loOP_status6_p3);
          fclose(fp6);
          }
...
// FILE *f;
    // f=fopen("/home/duc/result/check_dpid.log","a+");
    //   fprintf(f, "%ld\n",p->datapath_id);
    //   fclose(f);
